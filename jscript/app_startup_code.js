...
(async function () {
	...
	model = await tf.loadModel('http://child.test.woza.work/model_kaggle_3/model.json');
	$("#selected-image").attr("src", "http://child.test.woza.work/assets/default_image.jpeg");
